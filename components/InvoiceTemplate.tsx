...
const InvoiceTemplate = React.forwardRef<HTMLDivElement, InvoiceTemplateProps>(({ invoice }, ref) => {
    ...
    return (
        <div ref={ref} className="p-8 max-w-[210mm] mx-auto bg-[#ffffff] text-[#000000] text-xs font-sans border border-[#d1d5db] print:border-none">
            ...
            <div className="border border-[#000000] flex flex-col">
                ...
                <div className="flex border-b border-[#000000]">
                    <div className="w-1/2 p-2 border-r border-[#000000]">
                ...
                <table className="w-full border-collapse">
                    <thead>
                        <tr className="border-b border-[#000000]">
                            <th className="border-r border-[#000000] p-1 text-left w-10">Sl No.</th>
                            <th className="border-r border-[#000000] p-1 text-left">Description of Goods</th>
                            <th className="border-r border-[#000000] p-1 w-20">HSN/SAC</th>
                            <th className="border-r border-[#000000] p-1 w-20">Quantity</th>
                            <th className="border-r border-[#000000] p-1 w-16">Rate</th>
                            <th className="border-r border-[#000000] p-1 w-10">per</th>
                    ...
                    <tbody>
                        {invoice.items.map((item: InvoiceItem, index: number) => (
                            <tr key={index} className="align-top h-64">
                                <td className="border-r border-[#000000] p-1 text-center">{index + 1}</td>
                                <td className="border-r border-[#000000] p-1">
                                ...
                                <td className="border-r border-[#000000] p-1 text-center">
                    ...
                    <tfoot className="border-t border-[#000000]">
                        <tr>
                            <td colSpan={3} className="border-r border-[#000000] p-1 text-right font-bold">Total</td>
                            <td className="border-r border-[#000000] p-1 text-center font-bold">{invoice.items.reduce((s: number, i: InvoiceItem) => s + i.quantity, 0).toFixed(3)} KG</td>
                ...
                {/* Amount in words */}
                <div className="border-b border-[#000000] p-2">
                ...
                <div className="border-b border-[#000000]">
                    <table className="w-full text-center">
                        <thead>
                            <tr className="border-b border-[#000000]">
                                <th rowSpan={2} className="border-r border-[#000000]">HSN/SAC</th>
                                <th rowSpan={2} className="border-r border-[#000000]">Taxable Value</th>
                                <th colSpan={2} className="border-r border-[#000000] border-b">CGST</th>
                                <th colSpan={2} className="border-r border-[#000000] border-b">SGST/UTGST</th>
                                <th rowSpan={2}>Total Tax Amount</th>
                            </tr>
                            <tr>
                                <th className="border-r border-[#000000]">Rate</th>
                                <th className="border-r border-[#000000]">Amount</th>
                                <th className="border-r border-[#000000]">Rate</th>
                                <th className="border-r border-[#000000]">Amount</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td className="border-r border-[#000000]">392111</td>
                                <td className="border-r border-[#000000]">{formatCurrency(totalTaxable)}</td>
                                <td className="border-r border-[#000000]">9%</td>
                                <td className="border-r border-[#000000]">{formatCurrency(totalCGST)}</td>
                                <td className="border-r border-[#000000]">9%</td>
                                <td className="border-r border-[#000000]">{formatCurrency(totalSGST)}</td>
                                <td>{formatCurrency(totalCGST + totalSGST)}</td>
                            </tr>
                            <tr className="border-t border-[#000000] font-bold">
                                <td className="border-r border-[#000000] text-right">Total</td>
                                <td className="border-r border-[#000000]">{formatCurrency(totalTaxable)}</td>
